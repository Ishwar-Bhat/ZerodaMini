...
<script>
import VgtPaginationPageInfo from './vgt-lib.vue';
import {
  PAGINATION_MODES,
...
export default {
  ...
  props: {
    ...
    mode: { default: PAGINATION_MODES.Pages },
